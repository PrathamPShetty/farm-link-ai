...
class _NavBarState extends State<NavBar> {
            ...
            const DrawerHeader(
              ...
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage(consts.banner2),
                  ),
                  SizedBox(height: 8),
                  Text(
                    'Welcome!',
  ...
  List<Widget> _farmerMenuItems(BuildContext context) {
    return [
      ...
      _drawerItem(context, Icons.shopping_cart, 'Recommend Crop',
          '/farmer/recommend-crop'),
      _drawerItem(context, Icons.shopping_bag, 'Recommend Fertilizer',
          '/farmer/recommend-fertilizer'),
      _drawerItem(context, Icons.shopping_bag, 'Detect Crop Disease',
          '/farmer/detect-crop'),
  ...
  List<Widget> _customerMenuItems(BuildContext context) {
    return [
      ...
      _drawerItem(context, Icons.shopping_cart, 'Product', '/customer/product'),
